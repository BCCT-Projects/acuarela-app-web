...
<main>
  ...
  <div class="navtabs">
    ...
    <div class="navtab" data-index="5" data-target="coppa-consent">Consentimiento COPPA</div>
    ...
    <form action="s/createInscription/" method="POST" id="inscription" autocomplete="off">
      ...
      <div id="coppa-consent" class="tab-content">
        <section class="coppa-consent-section">
          ...
          <p>Antes de completar la inscripción, por favor lea y acepte el Aviso de Privacidad COPPA que explica cómo recopilamos, usamos y protegemos los datos de menores.</p>
          <div class="coppa-consent-box">
            <div class="cntr-check">
              ...
              <span>
                ...
                <a href="/miembros/acuarela-app-web/privacy/coppa" target="_blank" id="coppa-notice-link" class="coppa-link">
            ...
            <p class="coppa-consent-note">
              <small>Al marcar esta casilla, usted confirma que ha leído el aviso completo y otorga su consentimiento para el procesamiento de datos de su menor según se describe en el aviso.</small>
            </p>
          </div>
